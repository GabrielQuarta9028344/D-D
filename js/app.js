 const canvas = document.getElementById('gameCanvas');
    ...
    function resetGame() {
      ...
      riddleState = null;
      solvedRiddles = 0;
      // Verberg de next room knop bij nieuw spel
    ...
    function loadRiddles() {
      fetch('rooms/riddles_json.php')
        ...
        .then(data => {
          ...
          riddles = data;
          // Voeg hardcoded riddles toe en beperk tot 3 raadsels
          riddles = riddles.concat(hardcodedRiddles);
          riddles = riddles.slice(0, 3); // Neem alleen de eerste 3
        ...
        .catch(error => {
          ...
          console.log('Gebruik fallback hardcoded riddles');
    ...
    function triggerRiddle() {
      ...
      riddleState = 1; // Set riddleState so closeModal() works properly
      paused = true;
    }
    ...
    function closeModal() {
      ...
      riddleState = null;
      paused = false; // Zeker stellen dat het spel doorgaat
    }
    ...
    function checkAnswer() {
      ...
      if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
        ...
        if (solvedRiddles >= riddles.length) {
          feedback.innerText = 'Gefeliciteerd! Alle raadsels opgelost!';
          paused = true; // Stop het spel
          // Toon de "Ga naar Room 2" knop
        ...
        // Reset riddleState NIET paused - closeModal() zal paused = false zetten
        riddleState = null;
        // Sluit modal na korte vertraging - closeModal() zal het spel hervatten
    ...
    document.getElementById('nextRoomBtn').addEventListener('click', () => {
      // Controleer of we via localhost draaien (webserver) of file:// (direct bestand)
      if (window.location.protocol === 'file:') {
        // Als het een bestand is, ga naar game2.html
        window.location.href = 'game2.html';
      } else {
        // Als het via webserver is, ga naar game2.php
...
/* Timer  */
/* Timer code verwijderd - hoort niet bij game1.html */
